...
> [!IMPORTANT]
> 🚧 **Work In Progress**: This project is currently being built up. Features and APIs are subject to change.
...
### Create Real Estate
Send a `POST` request to `/create-realestate` to add a property and calculate salary eligibility.
...
```json
{
  "id": "abc12345",
  "rent_price": 1000.0,
  "minimum_salary_eligibility": 340.0
}
```
